...
@section('content')
  ...
  <div class="page-header">
    <h3 class="page-title"> Parceiro </h3>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
        <li class="breadcrumb-item active" aria-current="page">Actualizar Parceiro</li>
      </ol>
    </nav>
  </div>
  <div class="row">
    ...
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Actualizar Parceiro</h4>
            ...
            <div class="form-group">
                ...
                <div class="file-upload">
                  ...
                  <div class="file-upload-content">
                    <img class="file-upload-image" src="{{asset($partner->photo)}}" alt="your image" />
